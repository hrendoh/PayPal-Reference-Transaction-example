<?php
	...
	********************************************/
	...
	//'------------------------------------
	$API_UserName="seller_1307879563_biz_api1.example.com";
	$API_Password="xxxxxxxxxxx";
	$API_Signature="yyyyyyyyyyyyy";
	...
	*/
	function ConfirmPayment( $FinalPaymentAmt )
	{
		...
		$paymentType 		= "Sale";urlencode($_SESSION['PaymentType']);
		...
		#$nvpstr  = '&TOKEN=' . $token . '&PAYERID=' . $payerID . '&PAYMENTACTION=Any' . '&IPADDRESS=' . $serverName; 
	...
	function DoReferenceTransaction($paymentAmt,$currencyId)
	{
		//'--------------------------------------------------------------
		//' At this point, the buyer has completed authorizing the payment
		//' at PayPal.  The function will call PayPal to obtain the details
		...
		//'  ID to get the details on the payment authorization
		//'---------------------------------------------------------------------------
	    $nvpstr="&REFERENCEID=".$_SESSION['billing_agreemenet_id'];
